// <copyright file="SpendbackObject.cs" company="APIMatic">
// PayQuicker.API
//
...
namespace PayQuicker.API.Models
{
    ...
    /// SpendbackObject.
    /// </summary>
    public class SpendbackObject : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SpendbackObject"/> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            return $"SpendbackObject : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is SpendbackObject other &&
