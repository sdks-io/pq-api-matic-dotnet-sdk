// <copyright file="CreateInvitation.cs" company="APIMatic">
// PayQuicker.API
//
...
namespace PayQuicker.API.Models
{
    ...
    /// CreateInvitation.
    /// </summary>
    public class CreateInvitation : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateInvitation"/> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            return $"CreateInvitation : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is CreateInvitation other &&
