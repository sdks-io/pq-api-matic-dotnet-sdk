// <copyright file="ElectronicWalletListResult.cs" company="APIMatic">
// PayQuicker.API
//
...
namespace PayQuicker.API.Models
{
    ...
    /// </summary>
    public class ElectronicWalletListResult : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ElectronicWalletListResult"/> class.
        /// </summary>
        ...
        public ElectronicWalletListResult(
            List<Models.ElectronicWalletObject> payload,
        ...
        public List<Models.ElectronicWalletObject> Payload { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"ElectronicWalletListResult : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is ElectronicWalletListResult other &&
