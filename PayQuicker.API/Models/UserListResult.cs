// <copyright file="UserListResult.cs" company="APIMatic">
// PayQuicker.API
//
...
namespace PayQuicker.API.Models
{
    ...
    /// UserListResult.
    /// </summary>
    public class UserListResult : BaseModel
    {
        /// <summary>
        ...
        public UserListResult(
            List<Models.UserObject> payload,
        ...
        public List<Models.UserObject> Payload { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"UserListResult : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is UserListResult other &&
