// <copyright file="SpendbackResult.cs" company="APIMatic">
// PayQuicker.API
//
...
namespace PayQuicker.API.Models
{
    ...
    /// SpendbackResult.
    /// </summary>
    public class SpendbackResult : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SpendbackResult"/> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            return $"SpendbackResult : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is SpendbackResult other &&
