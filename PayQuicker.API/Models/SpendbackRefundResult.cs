// <copyright file="SpendbackRefundResult.cs" company="APIMatic">
// PayQuicker.API
//
...
namespace PayQuicker.API.Models
{
    ...
    /// </summary>
    public class SpendbackRefundResult : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SpendbackRefundResult"/> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            return $"SpendbackRefundResult : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is SpendbackRefundResult other &&
