// <copyright file="TransferObject.cs" company="APIMatic">
// PayQuicker.API
//
...
namespace PayQuicker.API.Models
{
    ...
    /// TransferObject.
    /// </summary>
    public class TransferObject : BaseModel
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            return $"TransferObject : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is TransferObject other &&
