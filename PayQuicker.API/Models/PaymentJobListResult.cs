// <copyright file="PaymentJobListResult.cs" company="APIMatic">
// PayQuicker.API
//
...
namespace PayQuicker.API.Models
{
    ...
    /// </summary>
    public class PaymentJobListResult : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentJobListResult"/> class.
        /// </summary>
        ...
        public PaymentJobListResult(
            List<Models.PaymentJobObject> payload,
        ...
        public List<Models.PaymentJobObject> Payload { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"PaymentJobListResult : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is PaymentJobListResult other &&
