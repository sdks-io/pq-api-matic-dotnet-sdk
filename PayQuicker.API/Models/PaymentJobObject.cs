// <copyright file="PaymentJobObject.cs" company="APIMatic">
// PayQuicker.API
//
...
namespace PayQuicker.API.Models
{
    ...
    /// PaymentJobObject.
    /// </summary>
    public class PaymentJobObject : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentJobObject"/> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            return $"PaymentJobObject : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is PaymentJobObject other &&
