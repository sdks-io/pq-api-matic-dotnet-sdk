// <copyright file="SpendbackRefundListResult.cs" company="APIMatic">
// PayQuicker.API
//
...
namespace PayQuicker.API.Models
{
    ...
    /// </summary>
    public class SpendbackRefundListResult : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SpendbackRefundListResult"/> class.
        /// </summary>
        ...
        public SpendbackRefundListResult(
            List<Models.SpendbackRefundObject> payload,
        ...
        public List<Models.SpendbackRefundObject> Payload { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"SpendbackRefundListResult : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is SpendbackRefundListResult other &&
