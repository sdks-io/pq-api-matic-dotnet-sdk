// <copyright file="ProgramListResult.cs" company="APIMatic">
// PayQuicker.API
//
...
namespace PayQuicker.API.Models
{
    ...
    /// ProgramListResult.
    /// </summary>
    public class ProgramListResult : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProgramListResult"/> class.
        /// </summary>
        ...
        public ProgramListResult(
            List<Models.ProgramObject> payload,
        ...
        public List<Models.ProgramObject> Payload { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"ProgramListResult : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is ProgramListResult other &&
