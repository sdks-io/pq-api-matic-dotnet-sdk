// <copyright file="ReceiptListResult.cs" company="APIMatic">
// PayQuicker.API
//
...
namespace PayQuicker.API.Models
{
    ...
    /// ReceiptListResult.
    /// </summary>
    public class ReceiptListResult : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReceiptListResult"/> class.
        /// </summary>
        ...
        public ReceiptListResult(
            List<Models.ReceiptObject> payload,
        ...
        public List<Models.ReceiptObject> Payload { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"ReceiptListResult : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is ReceiptListResult other &&
