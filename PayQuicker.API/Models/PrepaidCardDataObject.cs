// <copyright file="PrepaidCardDataObject.cs" company="APIMatic">
// PayQuicker.API
//
...
namespace PayQuicker.API.Models
{
    ...
    /// </summary>
    public class PrepaidCardDataObject : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PrepaidCardDataObject"/> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            return $"PrepaidCardDataObject : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is PrepaidCardDataObject other &&
