// <copyright file="PaymentListResult.cs" company="APIMatic">
// PayQuicker.API
//
...
namespace PayQuicker.API.Models
{
    ...
    /// PaymentListResult.
    /// </summary>
    public class PaymentListResult : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentListResult"/> class.
        /// </summary>
        ...
        public PaymentListResult(
            List<Models.PaymentObject> payload,
        ...
        public List<Models.PaymentObject> Payload { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"PaymentListResult : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is PaymentListResult other &&
