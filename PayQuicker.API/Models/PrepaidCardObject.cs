// <copyright file="PrepaidCardObject.cs" company="APIMatic">
// PayQuicker.API
//
...
namespace PayQuicker.API.Models
{
    ...
    /// PrepaidCardObject.
    /// </summary>
    public class PrepaidCardObject : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PrepaidCardObject"/> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            return $"PrepaidCardObject : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is PrepaidCardObject other &&
