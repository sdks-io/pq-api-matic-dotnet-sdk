// <copyright file="PrepaidCardDataTokenResult.cs" company="APIMatic">
// PayQuicker.API
//
...
namespace PayQuicker.API.Models
{
    ...
    /// </summary>
    public class PrepaidCardDataTokenResult : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PrepaidCardDataTokenResult"/> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            return $"PrepaidCardDataTokenResult : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is PrepaidCardDataTokenResult other &&
