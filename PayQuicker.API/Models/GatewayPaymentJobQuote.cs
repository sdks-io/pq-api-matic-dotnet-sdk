// <copyright file="GatewayPaymentJobQuote.cs" company="APIMatic">
// PayQuicker.API
//
...
namespace PayQuicker.API.Models
{
    ...
    /// </summary>
    public class GatewayPaymentJobQuote : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GatewayPaymentJobQuote"/> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            return $"GatewayPaymentJobQuote : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is GatewayPaymentJobQuote other &&
