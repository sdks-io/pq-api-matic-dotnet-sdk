// <copyright file="PaymentObject.cs" company="APIMatic">
// PayQuicker.API
//
...
namespace PayQuicker.API.Models
{
    ...
    /// PaymentObject.
    /// </summary>
    public class PaymentObject : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentObject"/> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            return $"PaymentObject : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is PaymentObject other &&
