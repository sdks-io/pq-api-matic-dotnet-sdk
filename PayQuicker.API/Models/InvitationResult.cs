// <copyright file="InvitationResult.cs" company="APIMatic">
// PayQuicker.API
//
...
namespace PayQuicker.API.Models
{
    ...
    /// InvitationResult.
    /// </summary>
    public class InvitationResult : BaseModel
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            return $"InvitationResult : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is InvitationResult other &&
