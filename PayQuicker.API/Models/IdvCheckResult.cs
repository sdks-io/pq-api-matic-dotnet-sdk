// <copyright file="IdvCheckResult.cs" company="APIMatic">
// PayQuicker.API
//
...
namespace PayQuicker.API.Models
{
    ...
    /// IdvCheckResult.
    /// </summary>
    public class IdvCheckResult : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdvCheckResult"/> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            return $"IdvCheckResult : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is IdvCheckResult other &&
