...
namespace PayQuicker.API
{
    ...
    public sealed class PayQuickerSDKClient : IPayQuickerSDKClient
    {
        ...
        internal static PayQuickerSDKClient CreateFromEnvironment()
        {
            ...
            string xMyPayQuickerVersion = System.Environment.GetEnvironmentVariable("PAY_QUICKER_API_X_MY_PAY_QUICKER_VERSION");
            string environment = System.Environment.GetEnvironmentVariable("PAY_QUICKER_API_ENVIRONMENT");
            string sandboxInstance = System.Environment.GetEnvironmentVariable("PAY_QUICKER_API_SANDBOX_INSTANCE");
            string uatInstance = System.Environment.GetEnvironmentVariable("PAY_QUICKER_API_UAT_INSTANCE");
            string oAuthClientId = System.Environment.GetEnvironmentVariable("PAY_QUICKER_API_O_AUTH_CLIENT_ID");
            string oAuthClientSecret = System.Environment.GetEnvironmentVariable("PAY_QUICKER_API_O_AUTH_CLIENT_SECRET");
            string accessToken = System.Environment.GetEnvironmentVariable("PAY_QUICKER_API_ACCESS_TOKEN");
        ...
        public class Builder
        {
            ...
            private Environment _environment = PayQuicker.API.Environment.Sandbox;
