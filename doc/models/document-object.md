...
|  --- | --- | --- | --- |
| `CreateDate` | `DateTime` | Required | Time object was [created](#/rest/models/structures/created-on) |
| `Fields` | [`List<DocumentDetails>`](../../doc/models/document-details.md) | Optional | **Constraints**: *Minimum Items*: `1`, *Unique Items Required* |
...
| `Links` | [`List<HateoasSelfRef>`](../../doc/models/hateoas-self-ref.md) | Required | **Constraints**: *Minimum Items*: `1`, *Maximum Items*: `10`, *Unique Items Required* |
