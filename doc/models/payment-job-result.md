...
| `FileToken` | `string` | Optional | [Token](#/rest/models/structures/token) representing the document<br><br>**Default**: `"docu-2053aaad-c1a5-45e2-a2da-f71287f32800"`<br><br>**Constraints**: *Minimum Length*: `41`, *Maximum Length*: `41`, *Pattern*: `^docu-[0-9A-Fa-f]{8}(?:-[0-9A-Fa-f]{4}){3}-[0-9A-Fa-f]{12}$` |
...
| `Items` | [`List<PaymentObject>`](../../doc/models/payment-object.md) | Optional | - |
