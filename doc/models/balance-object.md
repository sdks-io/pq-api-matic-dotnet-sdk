...
|  --- | --- | --- | --- |
| `Amount` | `double` | Required | Amount of money in the account<br><br>**Default**: `0` |
...
| `FormattedAmount` | `string` | Required | Combination of the amount and currency type<br><br>**Default**: `"$0.05 USD"` |
