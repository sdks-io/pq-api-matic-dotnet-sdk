...
```csharp
IReceiptsController receiptsController = client.ReceiptsController;
```
...
[`Task<Models.ReceiptListResult>`](../../doc/models/receipt-list-result.md)
...
try
{
    ReceiptListResult result = await receiptsController.ListAccountReceiptsAsync(
        accountToken,
        page,
        pageSize,
        filter,
...
try
{
    ReceiptListResult result = await receiptsController.ListPrepaidCardReceiptsAsync(
        userToken,
        destinationToken,
        page,
        pageSize,
...
try
{
    ReceiptListResult result = await receiptsController.ListUserReceiptsAsync(
        userToken,
        page,
        pageSize,
        filter,
...
[`Task<Models.ReceiptResult>`](../../doc/models/receipt-result.md)
...
try
{
    ReceiptResult result = await receiptsController.RetrieveAccountReceiptAsync(
        accountToken,
        receiptToken
    );
}
...
```csharp
RetrievePrepaidCardReceiptAsync(
    string userToken,
    string destinationToken,
    string receiptToken)
```
...
try
{
    ReceiptResult result = await receiptsController.RetrievePrepaidCardReceiptAsync(
        userToken,
        destinationToken,
        receiptToken
    );
...
try
{
    ReceiptResult result = await receiptsController.RetrieveUserReceiptAsync(
        userToken,
        receiptToken
    );
}
