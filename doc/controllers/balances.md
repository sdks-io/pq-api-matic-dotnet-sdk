...
[`Task<Models.BalanceListResult>`](../../doc/models/balance-list-result.md)
...
try
{
    BalanceListResult result = await balancesController.ListAccountBalancesAsync(
        accountToken,
        page,
        pageSize,
        filter,
...
try
{
    BalanceListResult result = await balancesController.ListUserBalancesAsync(
        userToken,
        page,
        pageSize,
        filter,
...
[`Task<Models.BalanceResult>`](../../doc/models/balance-result.md)
...
try
{
    BalanceResult result = await balancesController.RetrieveCardBalanceAsync(
        userToken,
        destinationToken,
        language
    );
