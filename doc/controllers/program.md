...
```csharp
IProgramController programController = client.ProgramController;
```
...
[`Task<Models.ProgramListResult>`](../../doc/models/program-list-result.md)
...
try
{
    ProgramListResult result = await programController.ListProgramsAsync(
        page,
        pageSize,
        filter,
        sort,
...
[`Task<Models.ProgramResult>`](../../doc/models/program-result.md)
...
try
{
    ProgramResult result = await programController.RetrieveProgramAsync(
        programToken,
        language
    );
}
