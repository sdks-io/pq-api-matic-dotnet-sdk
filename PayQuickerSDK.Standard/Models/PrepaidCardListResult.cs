// <copyright file="PrepaidCardListResult.cs" company="APIMatic">
...
namespace PayQuickerSDK.Standard.Models
{
    ...
    /// </summary>
    public class PrepaidCardListResult : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PrepaidCardListResult"/> class.
        /// </summary>
        ...
        public PrepaidCardListResult(
            List<Models.PrepaidCardObject> payload,
        ...
        public List<Models.PrepaidCardObject> Payload { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"PrepaidCardListResult : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is PrepaidCardListResult other &&
