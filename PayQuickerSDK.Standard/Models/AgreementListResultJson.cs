// <copyright file="AgreementListResultJson.cs" company="APIMatic">
...
namespace PayQuickerSDK.Standard.Models
{
    ...
    /// </summary>
    public class AgreementListResultJson : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AgreementListResultJson"/> class.
        /// </summary>
        ...
        public AgreementListResultJson(
            List<Models.AgreementObject> payload,
        ...
        public List<Models.AgreementObject> Payload { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"AgreementListResultJson : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is AgreementListResultJson other &&
