// <copyright file="DocumentListResult.cs" company="APIMatic">
...
namespace PayQuickerSDK.Standard.Models
{
    ...
    /// DocumentListResult.
    /// </summary>
    public class DocumentListResult : BaseModel
    {
        /// <summary>
        ...
        public DocumentListResult(
            List<Models.DocumentObject> payload,
        ...
        public List<Models.DocumentObject> Payload { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"DocumentListResult : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is DocumentListResult other &&
