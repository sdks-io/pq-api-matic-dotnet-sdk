// <copyright file="EventListResult.cs" company="APIMatic">
...
namespace PayQuickerSDK.Standard.Models
{
    ...
    /// EventListResult.
    /// </summary>
    public class EventListResult : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EventListResult"/> class.
        /// </summary>
        ...
        public EventListResult(
            List<Models.EventObject> payload,
        ...
        public List<Models.EventObject> Payload { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"EventListResult : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is EventListResult other &&
