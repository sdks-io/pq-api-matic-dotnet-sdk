// <copyright file="PortalTransferQuote.cs" company="APIMatic">
...
namespace PayQuickerSDK.Standard.Models
{
    ...
    /// PortalTransferQuote.
    /// </summary>
    public class PortalTransferQuote : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PortalTransferQuote"/> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            return $"PortalTransferQuote : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is PortalTransferQuote other &&
