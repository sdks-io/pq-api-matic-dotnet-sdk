// <copyright file="AuthorizationListResult.cs" company="APIMatic">
...
namespace PayQuickerSDK.Standard.Models
{
    ...
    /// </summary>
    public class AuthorizationListResult : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthorizationListResult"/> class.
        /// </summary>
        ...
        public AuthorizationListResult(
            List<Models.AuthorizationObject> payload,
        ...
        public List<Models.AuthorizationObject> Payload { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"AuthorizationListResult : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is AuthorizationListResult other &&
