// <copyright file="PortalPaymentQuote.cs" company="APIMatic">
...
namespace PayQuickerSDK.Standard.Models
{
    ...
    /// PortalPaymentQuote.
    /// </summary>
    public class PortalPaymentQuote : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PortalPaymentQuote"/> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            return $"PortalPaymentQuote : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is PortalPaymentQuote other &&
