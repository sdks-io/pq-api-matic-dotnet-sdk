// <copyright file="StatementObject.cs" company="APIMatic">
...
namespace PayQuickerSDK.Standard.Models
{
    ...
    /// StatementObject.
    /// </summary>
    public class StatementObject : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StatementObject"/> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            return $"StatementObject : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is StatementObject other &&
