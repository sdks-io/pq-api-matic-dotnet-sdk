// <copyright file="ElectronicWalletResult.cs" company="APIMatic">
...
namespace PayQuickerSDK.Standard.Models
{
    ...
    /// </summary>
    public class ElectronicWalletResult : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ElectronicWalletResult"/> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            return $"ElectronicWalletResult : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is ElectronicWalletResult other &&
