// <copyright file="SpendbackListResult.cs" company="APIMatic">
...
namespace PayQuickerSDK.Standard.Models
{
    ...
    /// SpendbackListResult.
    /// </summary>
    public class SpendbackListResult : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SpendbackListResult"/> class.
        /// </summary>
        ...
        public SpendbackListResult(
            List<Models.SpendbackObject> payload,
        ...
        public List<Models.SpendbackObject> Payload { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"SpendbackListResult : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is SpendbackListResult other &&
