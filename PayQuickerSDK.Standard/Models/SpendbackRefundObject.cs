// <copyright file="SpendbackRefundObject.cs" company="APIMatic">
...
namespace PayQuickerSDK.Standard.Models
{
    ...
    /// </summary>
    public class SpendbackRefundObject : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SpendbackRefundObject"/> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            return $"SpendbackRefundObject : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is SpendbackRefundObject other &&
