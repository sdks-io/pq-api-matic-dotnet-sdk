// <copyright file="UserObject.cs" company="APIMatic">
...
namespace PayQuickerSDK.Standard.Models
{
    ...
    /// UserObject.
    /// </summary>
    public class UserObject : BaseModel
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            return $"UserObject : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is UserObject other &&
