// <copyright file="GatewayPaymentJob.cs" company="APIMatic">
...
namespace PayQuickerSDK.Standard.Models
{
    ...
    /// GatewayPaymentJob.
    /// </summary>
    public class GatewayPaymentJob : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GatewayPaymentJob"/> class.
        /// </summary>
        ...
        public GatewayPaymentJob(
            ...
            List<Models.GatewayPaymentJobQuote> items = null)
        {
        ...
        public List<Models.GatewayPaymentJobQuote> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"GatewayPaymentJob : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is GatewayPaymentJob other &&
