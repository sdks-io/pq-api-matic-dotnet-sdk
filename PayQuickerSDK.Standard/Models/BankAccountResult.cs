// <copyright file="BankAccountResult.cs" company="APIMatic">
...
namespace PayQuickerSDK.Standard.Models
{
    ...
    /// BankAccountResult.
    /// </summary>
    public class BankAccountResult : BaseModel
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            return $"BankAccountResult : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is BankAccountResult other &&
