// <copyright file="EventObject.cs" company="APIMatic">
...
namespace PayQuickerSDK.Standard.Models
{
    ...
    /// EventObject.
    /// </summary>
    public class EventObject : BaseModel
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            return $"EventObject : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is EventObject other &&
