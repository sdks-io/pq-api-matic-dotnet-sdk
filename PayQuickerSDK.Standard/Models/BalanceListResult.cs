// <copyright file="BalanceListResult.cs" company="APIMatic">
...
namespace PayQuickerSDK.Standard.Models
{
    ...
    /// BalanceListResult.
    /// </summary>
    public class BalanceListResult : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BalanceListResult"/> class.
        /// </summary>
        ...
        public BalanceListResult(
            List<Models.BalanceObject> payload,
        ...
        public List<Models.BalanceObject> Payload { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"BalanceListResult : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is BalanceListResult other &&
