// <copyright file="TransferListResult.cs" company="APIMatic">
...
namespace PayQuickerSDK.Standard.Models
{
    ...
    /// TransferListResult.
    /// </summary>
    public class TransferListResult : BaseModel
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferListResult"/> class.
        /// </summary>
        ...
        public TransferListResult(
            List<Models.TransferObject> payload,
        ...
        public List<Models.TransferObject> Payload { get; set; }
        ...
        public override string ToString()
        {
            ...
            return $"TransferListResult : ({string.Join(", ", toStringOutput)})";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is TransferListResult other &&
